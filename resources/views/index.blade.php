...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">SHADOW</span>
        </a>
    </div>
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            <div class="d-flex my-3">
                ...
                <div class="form-check form-switch ps-0 ms-auto">
                    <input class="form-check-input" type="checkbox" id="navbarFixed" onchange="navbarFixed(this)">
                </div>
            </div>
            <!-- Footer Fixed -->
            <div class="d-flex">
                <h6 class="mb-0">Footer Fixed</h6>
                <div class="form-check form-switch ps-0 ms-auto">
                    <input class="form-check-input" type="checkbox" id="footerFixed" onchange="footerFixed(this)">
                </div>
            </div>
        </div>
    </div>
